...
class HyperLinearControl(torch.nn.Module):
    ...
    def __init__(self, A, B, batch_size,  device, hlayers, strategy, skip=False, act="SiLU",clip=10**2,std_scales=(1,1,1)):
        ...
        super(HyperLinearControl, self).__init__()
        ...
        if strategy == "HNC":
            ...
            self.poly = HNC_strategy(self.dim,outputdim, hlayers,batch_size,device,skip,act,self.clip,std_scales)
